...
async def start_stream(
    ...
    if await is_active_chat(CallbackQuery.message.chat.id):
        ...
        final_output = await CallbackQuery.message.reply_photo(
            photo=thumb,
            caption=(
                f"🎬<b>__Judulnya:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={videoid}) \n⏳<b>__Duration:__</b> {duration_min} \n💡<b>__Info:__</b> [Informasi](https://t.me/{BOT_USERNAME}?start=info_{videoid})\n👤<b>__Yang minta:__ </b>{CallbackQuery.from_user.mention} \n🚧<b>__Ngantri tolol:__</b> <b>#{position}!</b>"
            ),
