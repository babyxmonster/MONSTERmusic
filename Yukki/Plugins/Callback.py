        ...
        if Queues.is_empty(chat_id):
            ...
            if str(finxx) != "raw":
                ...
                final_output = await CallbackQuery.message.reply_photo(
                    ...
                    caption=(
                        f"<b>__Lagu yang tadi ganti jadi__</b>\n\n🎥<b>__Judulnya:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={videoid}) \n⏳<b>__Durasinya:__</b> {duration_min} Menit\n👤**__Yang minta:__** {mention}"
                    ),
                )
                os.remove(thumb)
                ...
                final_output = await CallbackQuery.message.reply_photo(
                    photo=thumb,
                    reply_markup=InlineKeyboardMarkup(buttons),
                    caption=f"<b>__Lagu ganti ganti jadi__</b>\n\n🎥<b>__Judulnya:__</b> {title} \n⏳<b>__Durasinya:__</b> {duration_min} Menit\n👤<b>__Yang minta:__ </b> {mention}",
                )
            await start_timer(
                videoid,
                duration_min,
    ...
    if not _playlist:
        ...
        for shikhar in _playlist:
            ...
            if await is_active_chat(chat_id):
                ...
                cap = f"🎥<b>__Judulnya:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={videoid}) \n💡<b>__Info:__</b> [Informasi](https://t.me/{BOT_USERNAME}?start=info_{videoid})\n👤**__Yang minta:__** {CallbackQuery.from_user.mention}"
                final_output = await CallbackQuery.message.reply_photo(
                    photo=thumb,
                    reply_markup=InlineKeyboardMarkup(buttons),
                    caption=cap,
