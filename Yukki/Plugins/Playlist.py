...
/playplaylist 
- Menilai Memainkan Daftar yang tersimpan.

/playlist 
- Cek Daftar Yang Tersimpan di Server.

/delmyplaylist
- Hapus Musik yang Ada Di daftar tersimpan anda.

/delgroupplaylist
- Hapus semua musik yang tersimpan di daftar putar Grup Anda [Membutuhkannya Hak Admin.]
...
async def playlist(_, message):
    ...
    await message.reply_photo(
        photo=thumb,
        caption=(
            f"**{MUSIC_BOT_NAME}'s Fitur Playlist**\n\nPilih Daftar putar, Yang Kamu Ingin kan **CEK!**"
        ),
        reply_markup=InlineKeyboardMarkup(buttons),
    )
    return
